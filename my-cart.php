...
foreach($value as $qty=> $val34){
				...
				mysqli_query($conn,"insert into orders(userId,productId,quantity,orderStatus) values('".$_SESSION['id']."','$qty','$val34','Pending')");
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="/onlineorderingtest/category.php?cid=1" class="btn btn-upper btn-primary outer-left-xs">Continue Shopping</a>
		...
		<thead>
			<tr>
				<th>
					...
					shipping fee: 50 <br>Grand Total<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
